...
const Universities: React.FC = () => {
    ...
    const goToUpadteOption = async (idx: number) => {
        ...
        try {
            ...
            const response = await fetch(`${BACKEND_URL}/admin/options/university/${idx}`, {
                method: "GET",
                headers: {
                    'token': `${token}`
                },
    ...
    const updateOption = () => {
        ...
        if (optionTitle) {
            fetch(`${BACKEND_URL}/admin/options/update/university`, {
                method: "PUT",
                headers: {
                    'token': `${token}`,
    ...
    const deleteOption = (idx: number) => {
        ...
        fetch(`${BACKEND_URL}/admin/options/delete/university`, {
            method: "DELETE",
            headers: {
                'token': `${token}`,
                "Content-Type": "application/json"
    ...
    const addOption = () => {
        ...
        if (optionTitle) {
            ...
            fetch(`${BACKEND_URL}/admin/options/add/university`, {
                method: "POST",
                headers: {
                    'token': `${token}`,
                    "Content-Type": "application/json",
