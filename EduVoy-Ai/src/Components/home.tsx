        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div>
                ...
                <div className='flex justify-between px-10 py-10 items-center'>
                    <div className='mx-10'>
                        <h1 className='my-5 font-bold text-2xl underline underline-offset-4'>EduVoy.ai: Your Gateway to Global Education</h1>
            ...
            <div>
                ...
                <div className='flex justify-between px-28 py-10 items-center'>
                    ...
                    >
                        ...
                        <button className='my-5 btn btn-primary'>Learn More</button>
                    </motion.div>
                    <motion.div
                        initial={{ opacity: 0, x: 30 }}
                        whileInView={{ opacity: 1, x: 0 }}
